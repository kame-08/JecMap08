...
class ContentViewModel:ObservableObject {
    ...
    let jec: [Jec] = [
        ...
        //入口
        Jec(nun: 3, name: "3号館", location: CLLocationCoordinate2D(latitude: 35.69850, longitude: 139.69830), aed: false),
        ...
        //入口
        Jec(nun: 7, name: "7号館", location: CLLocationCoordinate2D(latitude: 35.69890, longitude: 139.69681), aed: true),
